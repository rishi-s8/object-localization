...
model.compile(loss='mean_squared_error', optimizer = Adam(0.00005), metrics=['mse'])

model.summary()

model.load_weights('./regressor/model.h5')

encoded.trainable = True
regressor.trainable = True

filepath='./newRegressor/3model-full.h5'
filepath2='./newRegressor/3finalEpoch.h5'
...
for e in range(epochs):
    ...
    plt.savefig('./newRegressor/3plots/' + str(e) +'.png')
